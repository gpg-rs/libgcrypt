...
extern "C" {
    ...
    pub fn gcry_sexp_new(retsexp: *mut gcry_sexp_t, buffer: *const c_void, length: size_t, autodetect: c_int)
        -> gcry_error_t;
    pub fn gcry_sexp_create(
        retsexp: *mut gcry_sexp_t, buffer: *mut c_void, length: size_t, autodetect: c_int,
        freefnc: extern "C" fn(*mut c_void),
    ) -> gcry_error_t;
    pub fn gcry_sexp_sscan(retsexp: *mut gcry_sexp_t, erroff: *mut size_t, buffer: *const c_char, length: size_t)
        -> gcry_error_t;
    pub fn gcry_sexp_build(retsexp: *mut gcry_sexp_t, erroff: *mut size_t, format: *const c_char, ...)
        -> gcry_error_t;
    pub fn gcry_sexp_build_array(
        retsexp: *mut gcry_sexp_t, erroff: *mut size_t, format: *const c_char,
        arg_list: *mut *mut c_void,
    ) -> gcry_error_t;
    pub fn gcry_sexp_release(sexp: gcry_sexp_t);
    pub fn gcry_sexp_canon_len(buffer: *const c_uchar, length: size_t, erroff: *mut size_t, errcode: *mut gcry_error_t)
        -> size_t;
    pub fn gcry_sexp_sprint(sexp: gcry_sexp_t, mode: c_int, buffer: *mut c_void, maxlength: size_t)
        -> size_t;
    ...
    pub fn gcry_sexp_find_token(list: gcry_sexp_t, tok: *const c_char, toklen: size_t)
        -> gcry_sexp_t;
    ...
    pub fn gcry_sexp_nth_data(list: gcry_sexp_t, number: c_int, datalen: *mut size_t)
        -> *const c_char;
    #[cfg(feature = "v1_6_0")]
    pub fn gcry_sexp_nth_buffer(list: gcry_sexp_t, number: c_int, rlength: *mut size_t)
        -> *mut c_void;
    ...
    #[cfg(feature = "v1_6_0")]
    pub fn gcry_sexp_extract_param(sexp: gcry_sexp_t, path: *const c_char, list: *const c_char, ...)
        -> gcry_error_t;
    ...
    pub fn gcry_mpi_scan(
        ret_mpi: *mut gcry_mpi_t, format: gcry_mpi_format, buffer: *const c_void, buflen: size_t,
        nscanned: *mut size_t,
    ) -> gcry_error_t;
    pub fn gcry_mpi_print(
        format: gcry_mpi_format, buffer: *mut c_uchar, buflen: size_t, nwritten: *mut size_t,
        a: gcry_mpi_t,
    ) -> gcry_error_t;
    pub fn gcry_mpi_aprint(format: gcry_mpi_format, buffer: *mut *mut c_uchar, nwritten: *mut size_t, a: gcry_mpi_t)
        -> gcry_error_t;
    ...
    pub fn gcry_mpi_div(q: gcry_mpi_t, r: gcry_mpi_t, dividend: gcry_mpi_t, divisor: gcry_mpi_t, round: c_int);
    ...
    #[cfg(feature = "v1_6_0")]
    pub fn gcry_mpi_point_set(point: gcry_mpi_point_t, x: gcry_mpi_t, y: gcry_mpi_t, z: gcry_mpi_t)
        -> gcry_mpi_point_t;
    #[cfg(feature = "v1_6_0")]
    pub fn gcry_mpi_point_snatch_set(point: gcry_mpi_point_t, x: gcry_mpi_t, y: gcry_mpi_t, z: gcry_mpi_t)
        -> gcry_mpi_point_t;
    #[cfg(feature = "v1_6_0")]
    pub fn gcry_mpi_ec_new(r_ctx: *mut gcry_ctx_t, keyparam: gcry_sexp_t, curvename: *const c_char)
        -> gcry_error_t;
    #[cfg(feature = "v1_6_0")]
    pub fn gcry_mpi_ec_get_mpi(name: *const c_char, ctx: gcry_ctx_t, copy: c_int) -> gcry_mpi_t;
    #[cfg(feature = "v1_6_0")]
    pub fn gcry_mpi_ec_get_point(name: *const c_char, ctx: gcry_ctx_t, copy: c_int)
        -> gcry_mpi_point_t;
    #[cfg(feature = "v1_6_0")]
    pub fn gcry_mpi_ec_set_mpi(name: *const c_char, newvalue: gcry_mpi_t, ctx: gcry_ctx_t)
        -> gcry_error_t;
    #[cfg(feature = "v1_6_0")]
    pub fn gcry_mpi_ec_set_point(name: *const c_char, newvalue: gcry_mpi_point_t, ctx: gcry_ctx_t)
        -> gcry_error_t;
    #[cfg(feature = "v1_7_0")]
    pub fn gcry_mpi_ec_decode_point(result: gcry_mpi_point_t, value: gcry_mpi_t, ctx: gcry_ctx_t)
        -> gcry_error_t;
    #[cfg(feature = "v1_6_0")]
    pub fn gcry_mpi_ec_get_affine(x: gcry_mpi_t, y: gcry_mpi_t, point: gcry_mpi_point_t, ctx: gcry_ctx_t)
        -> c_int;
    #[cfg(feature = "v1_6_0")]
    ...
    pub fn gcry_cipher_open(handle: *mut gcry_cipher_hd_t, algo: c_int, mode: c_int, flags: c_uint)
        -> gcry_error_t;
    pub fn gcry_cipher_close(handle: gcry_cipher_hd_t);
    pub fn gcry_cipher_ctl(handle: gcry_cipher_hd_t, cmd: c_int, buffer: *mut c_void, buflen: size_t)
        -> gcry_error_t;
    pub fn gcry_cipher_info(handle: gcry_cipher_hd_t, what: c_int, buffer: *mut c_void, nbytes: *mut size_t)
        -> gcry_error_t;
    pub fn gcry_cipher_algo_info(algo: c_int, what: c_int, buffer: *mut c_void, nbytes: *mut size_t)
        -> gcry_error_t;
    ...
    pub fn gcry_cipher_encrypt(
        handle: gcry_cipher_hd_t, output: *mut c_void, outsize: size_t, input: *const c_void,
        inlen: size_t,
    ) -> gcry_error_t;
    ...
    pub fn gcry_cipher_setkey(handle: gcry_cipher_hd_t, key: *const c_void, keylen: size_t)
        -> gcry_error_t;
    pub fn gcry_cipher_setiv(handle: gcry_cipher_hd_t, iv: *const c_void, ivlen: size_t)
        -> gcry_error_t;
    pub fn gcry_cipher_setctr(handle: gcry_cipher_hd_t, ctr: *const c_void, ctrlen: size_t)
        -> gcry_error_t;
    pub fn gcry_cipher_authenticate(handle: gcry_cipher_hd_t, abuf: *const c_void, abuflen: size_t)
        -> gcry_error_t;
    pub fn gcry_cipher_gettag(handle: gcry_cipher_hd_t, outtag: *mut c_void, taglen: size_t)
        -> gcry_error_t;
    pub fn gcry_cipher_checktag(handle: gcry_cipher_hd_t, in_tag: *const c_void, taglen: size_t)
        -> gcry_error_t;

    pub fn gcry_pk_encrypt(result: *mut gcry_sexp_t, data: gcry_sexp_t, pkey: gcry_sexp_t)
        -> gcry_error_t;
    pub fn gcry_pk_decrypt(result: *mut gcry_sexp_t, data: gcry_sexp_t, skey: gcry_sexp_t)
        -> gcry_error_t;
    pub fn gcry_pk_sign(result: *mut gcry_sexp_t, data: gcry_sexp_t, skey: gcry_sexp_t)
        -> gcry_error_t;
    pub fn gcry_pk_verify(sigval: gcry_sexp_t, data: gcry_sexp_t, pkey: gcry_sexp_t)
        -> gcry_error_t;
    ...
    pub fn gcry_pk_algo_info(algo: c_int, what: c_int, buffer: *mut c_void, nbytes: *mut size_t)
        -> gcry_error_t;
    ...
    pub fn gcry_pk_get_curve(key: gcry_sexp_t, iterator: c_int, r_nbits: *mut c_uint)
        -> *const c_char;
    pub fn gcry_pk_get_param(algo: c_int, name: *const c_char) -> gcry_sexp_t;
    pub fn gcry_pubkey_get_sexp(r_sexp: *mut gcry_sexp_t, mode: c_int, ctx: gcry_ctx_t)
        -> gcry_error_t;
    ...
    pub fn gcry_md_ctl(h: gcry_md_hd_t, cmd: c_int, buffer: *mut c_void, buflen: size_t)
        -> gcry_error_t;
    ...
    #[cfg(feature = "v1_7_0")]
    pub fn gcry_md_extract(hd: gcry_md_hd_t, algo: c_int, buffer: *mut c_void, length: size_t)
        -> gcry_error_t;
    pub fn gcry_md_hash_buffer(algo: c_int, digest: *mut c_void, buffer: *const c_void, length: size_t);
    ...
    pub fn gcry_md_info(h: gcry_md_hd_t, what: c_int, buffer: *mut c_void, nbytes: *mut size_t)
        -> gcry_error_t;
    pub fn gcry_md_algo_info(algo: c_int, what: c_int, buffer: *mut c_void, nbytes: *mut size_t)
        -> gcry_error_t;
    ...
    pub fn gcry_mac_open(handle: *mut gcry_mac_hd_t, algo: c_int, flags: c_uint, ctx: gcry_ctx_t)
        -> gcry_error_t;
    pub fn gcry_mac_close(h: gcry_mac_hd_t);
    pub fn gcry_mac_ctl(h: gcry_mac_hd_t, cmd: c_int, buffer: *mut c_void, buflen: size_t)
        -> gcry_error_t;
    pub fn gcry_mac_algo_info(algo: c_int, what: c_int, buffer: *mut c_void, nbytes: *mut size_t)
        -> gcry_error_t;
    pub fn gcry_mac_setkey(h: gcry_mac_hd_t, key: *const c_void, keylen: size_t) -> gcry_error_t;
    pub fn gcry_mac_setiv(h: gcry_mac_hd_t, iv: *const c_void, ivlen: size_t) -> gcry_error_t;
    pub fn gcry_mac_write(h: gcry_mac_hd_t, buffer: *const c_void, length: size_t) -> gcry_error_t;
    pub fn gcry_mac_read(h: gcry_mac_hd_t, buffer: *mut c_void, buflen: *mut size_t)
        -> gcry_error_t;
    ...
    pub fn gcry_kdf_derive(
        passphrase: *const c_void, passphraselen: size_t, algo: c_int, subalgo: c_int,
        salt: *const c_void, saltlen: size_t, iterations: c_ulong, keysize: size_t,
        keybuffer: *mut c_void,
    ) -> gcry_error_t;

    pub fn gcry_randomize(buffer: *mut c_void, length: size_t, level: gcry_random_level_t);
    pub fn gcry_random_add_bytes(buffer: *const c_void, length: size_t, quality: c_int)
        -> gcry_error_t;
    ...
    pub fn gcry_prime_generate(
        prime: *mut gcry_mpi_t, prime_bits: c_uint, factor_bits: c_uint,
        factors: *mut *mut gcry_mpi_t, cb: gcry_prime_check_func_t, cb_arg: *mut c_void,
        random_level: gcry_random_level_t, flags: c_uint,
    ) -> gcry_error_t;
    pub fn gcry_prime_group_generator(r_g: *mut gcry_mpi_t, prime: gcry_mpi_t, factors: *mut gcry_mpi_t, start_g: gcry_mpi_t)
        -> gcry_error_t;
    ...
    pub fn gcry_set_allocation_handler(
        func_alloc: gcry_handler_alloc_t, func_alloc_secure: gcry_handler_alloc_t,
        func_secure_check: gcry_handler_secure_check_t, func_realloc: gcry_handler_realloc_t,
