...
use gcrypt::cipher::{self, Cipher, Algorithm as CipherAlgorithm, Mode as CipherMode};
use gcrypt::digest::{self, MessageDigest, Algorithm as DigestAlgorithm};
use gcrypt::kdf;
...
fn test_bulk_cipher_modes() {
    ...
    let specs: &[(CipherAlgorithm, CipherMode, &[u8], &[u8], [u8; 20])] = &[
        (CipherAlgorithm::Aes, CipherMode::Cfb,
        ...
        (CipherAlgorithm::Aes256, CipherMode::Cfb,
...
fn test_digests() {
    ...
    let specs: &[(DigestAlgorithm, &[u8], &[u8])] = &[
        ...
        (DigestAlgorithm::Crc32Rfc1510, b"test0123456789", b"\xb8\x3e\x88\xd6"),
        (DigestAlgorithm::Crc32Rfc1510, b"MASSACHVSETTS INSTITVTE OF TECHNOLOGY", b"\xe3\x41\x80\xf7"),
        ...
        (DigestAlgorithm::Whirlpool, b"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",
        ...
        (DigestAlgorithm::GostR3411_94, b"This is message, length=32 bytes",
        ...
        (DigestAlgorithm::GostR3411_94, b"Suppose the original message has length = 50 bytes",
        ...
        (DigestAlgorithm::GostR3411_94, b"",
        ...
        (DigestAlgorithm::Stribog512, b"012345678901234567890123456789012345678901234567890123456789012",
        ...
        (DigestAlgorithm::Stribog256, b"012345678901234567890123456789012345678901234567890123456789012",
...
fn test_hmacs() {
    ...
    let specs: &[(DigestAlgorithm, &[u8], &[u8], &[u8])] = &[
        (DigestAlgorithm::Md5, b"what do ya want for nothing?", b"Jefe",
        ...
        (DigestAlgorithm::Md5, b"Test With Truncation",
        ...
        (DigestAlgorithm::Md5, b"Test Using Larger Than Block-Size Key - Hash Key First",
        ...
        (DigestAlgorithm::Sha256, b"what do ya want for nothing?", b"Jefe",
        ...
        (DigestAlgorithm::Sha224, b"what do ya want for nothing?", b"Jefe",
        ...
        (DigestAlgorithm::Sha384, b"what do ya want for nothing?", b"Jefe",
        ...
        (DigestAlgorithm::Sha512, b"what do ya want for nothing?", b"Jefe",
...
fn check_s2k() {
    let test_vectors: &[(&[u8], digest::Algorithm, Option<&[u8]>, u32, &[u8])] = &[
        (b"\x61", DigestAlgorithm::Md5, None, 0,
         b"\x0c\xc1\x75\xb9\xc0\xf1\xb6\xa8\x31\xc3\x99\xe2\x69\x77\x26\x61"),
        (b"\x61\x62", DigestAlgorithm::Md5, None, 0,
         b"\x18\x7e\xf4\x43\x61\x22\xd1\xcc\x2f\x40\xdc\x2b\x92\xf0\xeb\xa0"),
        (b"\x61\x62\x63", DigestAlgorithm::Md5, None, 0,
         b"\x90\x01\x50\x98\x3c\xd2\x4f\xb0\xd6\x96\x3f\x7d\x28\xe1\x7f\x72"),
        (b"\x61\x62\x63\x64", DigestAlgorithm::Md5, None, 0,
         b"\xe2\xfc\x71\x4c\x47\x27\xee\x93\x95\xf3\x24\xcd\x2e\x7f\x33\x1f"),
        (b"\x61\x62\x63\x64\x65", DigestAlgorithm::Md5, None, 0,
         b"\xab\x56\xb4\xd9\x2b\x40\x71\x3a\xcc\x5a\xf8\x99\x85\xd4\xb7\x86"),
        (b"\x61\x62\x63\x64\x65\x66", DigestAlgorithm::Md5, None, 0,
         b"\xe8\x0b\x50\x17\x09\x89\x50\xfc\x58\xaa\xd8\x3c\x8c\x14\x97\x8e"),
        (b"\x61\x62\x63\x64\x65\x66\x67", DigestAlgorithm::Md5, None, 0,
         b"\x7a\xc6\x6c\x0f\x14\x8d\xe9\x51\x9b\x8b\xd2\x64\x31\x2c\x4d\x64"),
        (b"\x61\x62\x63\x64\x65\x66\x67\x68", DigestAlgorithm::Md5, None, 0,
         b"\xe8\xdc\x40\x81\xb1\x34\x34\xb4\x51\x89\xa7\x20\xb7\x7b\x68\x18"),
        (b"\x61\x62\x63\x64\x65\x66\x67\x68\x69", DigestAlgorithm::Md5, None, 0,
        ...
        (b"\x61\x62\x63\x64\x65\x66\x67\x68\x69\x6a\x6b\x6c\x6d\x6e\x6f\x70\
           \x71", DigestAlgorithm::Md5, None, 0,
        ...
        (b"\x57\x69\x74\x68\x5f\x75\x74\x66\x38\x5f\x75\x6d\x6c\x61\x75\x74\
           \x73\x3a\xc3\xa4\xc3\xbc\xc3\x96\xc3\x9f", DigestAlgorithm::Sha1, None, 0,
         b"\xe0\x4e\x1e\xe3\xad\x0b\x49\x7c\x7a\x5f\x37\x3b\x4d\x90\x3c\x2e"),
        (b"\x61", DigestAlgorithm::Sha1, Some(b"\x6d\x47\xe3\x68\x5d\x2c\x36\x16"), 1024,
         b"\x41\x9f\x48\x6e\xbf\xe6\xdd\x05\x9a\x72\x23\x17\x44\xd8\xd3\xf3"),
        (b"\x61\x62", DigestAlgorithm::Sha1, Some(b"\x7c\x34\x78\xfb\x28\x2d\x25\xc7"), 1024,
         b"\x0a\x9d\x09\x06\x43\x3d\x4f\xf9\x87\xd6\xf7\x48\x90\xde\xd1\x1c"),
        (b"\x61\x62\x63", DigestAlgorithm::Sha1, Some(b"\xc3\x16\x37\x2e\x27\xf6\x9f\x6f"), 1024,
         b"\xf8\x27\xa0\x07\xc6\xcb\xdd\xf1\xfe\x5c\x88\x3a\xfc\xcd\x84\x4d"),
        (b"\x61\x62\x63\x64", DigestAlgorithm::Sha1,
         Some(b"\xf0\x0c\x73\x38\xb7\xc3\xd5\x14"), 1024,
         b"\x9b\x5f\x26\xba\x52\x3b\xcd\xd9\xa5\x2a\xef\x3c\x03\x4d\xd1\x52"),
        (b"\x61\x62\x63\x64\x65", DigestAlgorithm::Sha1,
         Some(b"\xe1\x7d\xa2\x36\x09\x59\xee\xc5"), 1024,
         b"\x94\x9d\x5b\x1a\x5a\x66\x8c\xfa\x8f\x6f\x22\xaf\x8b\x60\x9f\xaf"),
        (b"\x61\x62\x63\x64\x65\x66", DigestAlgorithm::Sha1,
         Some(b"\xaf\xa7\x0c\x68\xdf\x7e\xaa\x27"), 1024,
         b"\xe5\x38\xf4\x39\x62\x27\xcd\xcc\x91\x37\x7f\x1b\xdc\x58\x64\x27"),
        (b"\x61\x62\x63\x64\x65\x66\x67", DigestAlgorithm::Sha1,
         Some(b"\x40\x57\xb2\x9d\x5f\xbb\x11\x4f"), 1024,
         b"\xad\xa2\x33\xd9\xdd\xe0\xfb\x94\x8e\xcc\xec\xcc\xb3\xa8\x3a\x9e"),
        (b"\x61\x62\x63\x64\x65\x66\x67\x68", DigestAlgorithm::Sha1,
         Some(b"\x38\xf5\x65\xc5\x0f\x8c\x19\x61"), 1024,
         b"\xa0\xb0\x3e\x29\x76\xe6\x8f\xa0\xd8\x34\x8f\xa4\x2d\xfd\x65\xee"),
        (b"\x61\x62\x63\x64\x65\x66\x67\x68\x69", DigestAlgorithm::Sha1,
         Some(b"\xc3\xb7\x99\xcc\xda\x2d\x05\x7b"), 1024,
         b"\x27\x21\xc8\x99\x5f\xcf\x20\xeb\xf2\xd9\xff\x6a\x69\xff\xad\xe8"),
        (b"\x61\x62\x63\x64\x65\x66\x67\x68\x69\x6a\x6b\x6c\x6d\x6e\x6f", DigestAlgorithm::Sha1,
         Some(b"\x7d\xd8\x68\x8a\x1c\xc5\x47\x22"), 1024,
         b"\x0f\x96\x7a\x12\x23\x54\xf6\x92\x61\x67\x07\xb4\x68\x17\xb8\xaa"),
        (b"\x61\x62\x63\x64\x65\x66\x67\x68\x69\x6a\x6b\x6c\x6d\x6e\x6f\x70",
         DigestAlgorithm::Sha1, Some(b"\x8a\x95\xd4\x88\x0b\xb8\xe9\x9d"), 1024,
         b"\xcc\xe4\xc8\x82\x53\x32\xf1\x93\x5a\x00\xd4\x7f\xd4\x46\xfa\x07"),
        (b"\x61\x62\x63\x64\x65\x66\x67\x68\x69\x6a\x6b\x6c\x6d\x6e\x6f\x70\
           \x71", DigestAlgorithm::Sha1, Some(b"\xb5\x22\x48\xa6\xc4\xad\x74\x67"), 1024,
         b"\x0c\xe3\xe0\xee\x3d\x8f\x35\xd2\x35\x14\x14\x29\x0c\xf1\xe3\x34"),
        (b"\x61\x62\x63\x64\x65\x66\x67\x68\x69\x6a\x6b\x6c\x6d\x6e\x6f\x70\
           \x71\x72", DigestAlgorithm::Sha1, Some(b"\xac\x9f\x04\x63\x83\x0e\x3c\x95"), 1024,
         b"\x49\x0a\x04\x68\xa8\x2a\x43\x6f\xb9\x73\x94\xb4\x85\x9a\xaa\x0e"),
        (b"\x61\x62\x63\x64\x65\x66\x67\x68\x69\x6a\x6b\x6c\x6d\x6e\x6f\x70\
           \x71\x72\x73", DigestAlgorithm::Sha1, Some(b"\x03\x6f\x60\x30\x3a\x19\x61\x0d"), 1024,
         b"\x15\xe5\x9b\xbf\x1c\xf0\xbe\x74\x95\x1a\xb2\xc4\xda\x09\xcd\x99"),
        (b"\x61\x62\x63\x64\x65\x66\x67\x68\x69\x6a\x6b\x6c\x6d\x6e\x6f\x70\
           \x71\x72\x73\x74", DigestAlgorithm::Sha1,
         Some(b"\x51\x40\xa5\x57\xf5\x28\xfd\x03"), 1024,
         b"\xa6\xf2\x7e\x6b\x30\x4d\x8d\x67\xd4\xa2\x7f\xa2\x57\x27\xab\x96"),
        (b"\x61\x62\x63\x64\x65\x66\x67\x68\x69\x6a\x6b\x6c\x6d\x6e\x6f\x70\
           \x71\x72\x73\x74\x75", DigestAlgorithm::Sha1,
         Some(b"\x4c\xf1\x10\x11\x04\x70\xd3\x6e"), 1024,
         b"\x2c\x50\x79\x8d\x83\x23\xac\xd6\x22\x29\x37\xaf\x15\x0d\xdd\x8f"),
        (b"\x57\x69\x74\x68\x5f\x75\x74\x66\x38\x5f\x75\x6d\x6c\x61\x75\x74\
           \x73\x3a\xc3\xa4\xc3\xbc\xc3\x96\xc3\x9f", DigestAlgorithm::Sha1,
         Some(b"\xfe\x3a\x25\xcb\x78\xef\xe1\x21"), 1024,
         b"\x2a\xb0\x53\x08\xf3\x2f\xd4\x6e\xeb\x01\x49\x5d\x87\xf6\x27\xf6"),
        (b"\x4c\x6f\x6e\x67\x5f\x73\x65\x6e\x74\x65\x6e\x63\x65\x5f\x75\x73\
           \x65\x64\x5f\x61\x73\x5f\x70\x61\x73\x73\x70\x68\x72\x61\x73\x65",
         DigestAlgorithm::Sha1, Some(b"\x04\x97\xd0\x02\x6a\x44\x2d\xde"), 1024,
         b"\x57\xf5\x70\x41\xa0\x9b\x8c\x09\xca\x74\xa9\x22\xa5\x82\x2d\x17"),
        (b"\x4c\x6f\x6e\x67\x5f\x73\x65\x6e\x74\x65\x6e\x63\x65\x5f\x75\x73\
           \x65\x64\x5f\x61\x73\x5f\x70\x61\x73\x73\x70\x68\x72\x61\x73\x65",
         DigestAlgorithm::Sha1, Some(b"\xdd\xf3\x31\x7c\xce\xf4\x81\x26"), 10240,
         b"\xc3\xdd\x01\x6d\xaf\xf6\x58\xc8\xd7\x79\xb4\x40\x00\xb5\xe8\x0b"),
        (b"\x4c\x6f\x6e\x67\x5f\x73\x65\x6e\x74\x65\x6e\x63\x65\x5f\x75\x73\
           \x65\x64\x5f\x61\x73\x5f\x70\x61\x73\x73\x70\x68\x72\x61\x73\x65",
         DigestAlgorithm::Sha1, Some(b"\x95\xd6\x72\x4e\xfb\xe1\xc3\x1a"), 102400,
         b"\xf2\x3f\x36\x7f\xb4\x6a\xd0\x3a\x31\x9e\x65\x11\x8e\x2b\x99\x9b"),
        (b"\x61", DigestAlgorithm::Sha1, Some(b"\x6d\x69\x15\x18\xe4\x13\x42\x82"), 1024,
         b"\x28\x0c\x7e\xf2\x31\xf6\x1c\x6b\x5c\xef\x6a\xd5\x22\x64\x97\x91\
           \xe3\x5e\x37\xfd\x50\xe2\xfc\x6c"),
        (b"\x61\x62\x63\x64\x65\x66\x67", DigestAlgorithm::Sha1,
         Some(b"\x9b\x76\x5e\x81\xde\x13\xdf\x15"), 1024,
         b"\x91\x1b\xa1\xc1\x7b\x4f\xc3\xb1\x80\x61\x26\x08\xbe\x53\xe6\x50\
           \x40\x6f\x28\xed\xc6\xe6\x67\x55"),
        (b"\x61\x62\x63\x64\x65\x66\x67\x68\x69", DigestAlgorithm::Sha1,
         Some(b"\x7a\xac\xcc\x6e\x15\x56\xbd\xa1"), 1024,
         b"\xfa\x7e\x20\x07\xb6\x47\xb0\x09\x46\xb8\x38\xfb\xa1\xaf\xf7\x75\
           \x2a\xfa\x77\x14\x06\x54\xcb\x34"),
        (b"\x61\x62\x63\x64\x65\x66\x67\x68\x69", DigestAlgorithm::Sha1,
         Some(b"\x1c\x68\xf8\xfb\x98\xf7\x8c\x39"), 1024,
         b"\xcb\x1e\x86\xf5\xe0\xe4\xfb\xbf\x71\x34\x99\x24\xf4\x39\x8c\xc2\
           \x8e\x25\x1c\x4c\x96\x47\x22\xe8"),
        (b"\x4c\x6f\x6e\x67\x5f\x73\x65\x6e\x74\x65\x6e\x63\x65\x5f\x75\x73\
           \x65\x64\x5f\x61\x73\x5f\x70\x61\x73\x73\x70\x68\x72\x61\x73\x65",
         DigestAlgorithm::Sha1, Some(b"\x10\xa9\x4e\xc1\xa5\xec\x17\x52"), 1024,
         b"\x0f\x83\xa2\x77\x92\xbb\xe4\x58\x68\xc5\xf2\x14\x6e\x6e\x2e\x6b\
           \x98\x17\x70\x92\x07\x44\xe0\x51"),
        (b"\x61", DigestAlgorithm::Sha1, Some(b"\xef\x8f\x37\x61\x8f\xab\xae\x4f"), 1024,
        ...
        (b"\x61\x62\x63\x64\x65\x66\x67", DigestAlgorithm::Sha1,
         Some(b"\xaa\xfb\xd9\x06\x7d\x7c\x40\xaf"), 1024,
        ...
        (b"\x61\x62\x63\x64\x65\x66\x67\x68\x69", DigestAlgorithm::Sha1,
         Some(b"\x58\x03\x4f\x56\x8b\x97\xd4\x98"), 1024,
        ...
        (b"\x61\x62\x63\x64\x65\x66\x67\x68\x69", DigestAlgorithm::Sha1,
         Some(b"\x5d\x41\x3d\xa3\xa7\xfc\x5d\x0c"), 1024,
        ...
        (b"\x4c\x6f\x6e\x67\x5f\x73\x65\x6e\x74\x65\x6e\x63\x65\x5f\x75\x73\
           \x65\x64\x5f\x61\x73\x5f\x70\x61\x73\x73\x70\x68\x72\x61\x73\x65",
         DigestAlgorithm::Sha1, Some(b"\xca\xa7\xdc\x59\xce\x31\xe7\x49"), 1024,
        ...
        (b"\x4c\x6f\x6e\x67\x5f\x73\x65\x6e\x74\x65\x6e\x63\x65\x5f\x75\x73\
           \x65\x64\x5f\x61\x73\x5f\x70\x61\x73\x73\x70\x68\x72\x61\x73\x65",
         DigestAlgorithm::Sha256, None, 0,
         b"\x88\x36\x78\x6b\xd9\x5a\x62\xff\x47\xd3\xfb\x79\xc9\x08\x70\x56"),
        (b"\x4c\x6f\x6e\x67\x5f\x73\x65\x6e\x74\x65\x6e\x63\x65\x5f\x75\x73\
           \x65\x64\x5f\x61\x73\x5f\x70\x61\x73\x73\x70\x68\x72\x61\x73\x65",
         DigestAlgorithm::Sha256, Some(b"\x05\x8b\xfe\x31\xaa\xf3\x29\x11"), 0,
         b"\xb2\x42\xfe\x5e\x09\x02\xd9\x62\xb9\x35\xf3\xa8\x43\x80\x9f\xb1"),
        (b"\x4c\x6f\x6e\x67\x5f\x73\x65\x6e\x74\x65\x6e\x63\x65\x5f\x75\x73\
           \x65\x64\x5f\x61\x73\x5f\x70\x61\x73\x73\x70\x68\x72\x61\x73\x65",
         DigestAlgorithm::Sha256, Some(b"\xd3\x4a\xea\xc9\x97\x1b\xcc\x83"), 1024,
         b"\x35\x37\x99\x62\x07\x26\x68\x23\x05\x47\xb2\xa0\x0b\x2b\x2b\x8d"),
        (b"\x4c\x6f\x6e\x67\x5f\x73\x65\x6e\x74\x65\x6e\x63\x65\x5f\x75\x73\
           \x65\x64\x5f\x61\x73\x5f\x70\x61\x73\x73\x70\x68\x72\x61\x73\x65",
         DigestAlgorithm::Sha256, Some(b"\x5e\x71\xbd\x00\x5f\x96\xc4\x23"), 10240,
         b"\xa1\x6a\xee\xba\xde\x73\x25\x25\xd1\xab\xa0\xc5\x7e\xc6\x39\xa7"),
        (b"\x4c\x6f\x6e\x67\x5f\x73\x65\x6e\x74\x65\x6e\x63\x65\x5f\x75\x73\
           \x65\x64\x5f\x61\x73\x5f\x70\x61\x73\x73\x70\x68\x72\x61\x73\x65",
         DigestAlgorithm::Sha384, Some(b"\xc3\x08\xeb\x17\x62\x08\x89\xef"), 1024,
         b"\x9b\x7f\x0c\x81\x6f\x71\x59\x9b\xd5\xf6\xbf\x3a\x86\x20\x16\x33"),
        (b"\x4c\x6f\x6e\x67\x5f\x73\x65\x6e\x74\x65\x6e\x63\x65\x5f\x75\x73\
           \x65\x64\x5f\x61\x73\x5f\x70\x61\x73\x73\x70\x68\x72\x61\x73\x65",
         DigestAlgorithm::Sha512, Some(b"\xe6\x7d\x13\x6b\x39\xe3\x44\x05"), 1024,
         b"\xc8\xcd\x4b\xa4\xf3\xf1\xd5\xb0\x59\x06\xf0\xbb\x89\x34\x6a\xad"),
        (b"\x4c\x6f\x6e\x67\x5f\x73\x65\x6e\x74\x65\x6e\x63\x65\x5f\x75\x73\
           \x65\x64\x5f\x61\x73\x5f\x70\x61\x73\x73\x70\x68\x72\x61\x73\x65",
         DigestAlgorithm::Sha512, Some(b"\xed\x7d\x30\x47\xe4\xc3\xf8\xb6"), 1024,
        ...
        (b"\x4c\x6f\x6e\x67\x5f\x73\x65\x6e\x74\x65\x6e\x63\x65\x5f\x75\x73\
           \x65\x64\x5f\x61\x73\x5f\x70\x61\x73\x73\x70\x68\x72\x61\x73\x65",
         DigestAlgorithm::Sha512, Some(b"\xbb\x1a\x45\x30\x68\x62\x6d\x63"), 1024,
...
fn check_pbkdf2() {
    ...
    for tv in test_vectors {
        ...
        kdf::pbkdf2_derive(DigestAlgorithm::Sha1, tv.2, tv.0.as_bytes(),
...
fn check_scrypt() {
    let test_vectors: &[(&str, &str, u32, u32, &[u8])] = &[
        ...
        ("pleaseletmein", "SodiumChloride", 16384, 1,
...
fn check_pkey_sign(algo: KeyAlgorithm, skey: &SExpression, pkey: &SExpression) {
    let specs: &[(&[u8], Option<KeyAlgorithm>, ErrorCode)] = &[
        ...
        (b"(data\n (flags pkcs1)\n\
         ...
         Some(KeyAlgorithm::Rsa), error::GPG_ERR_DIGEST_ALGO),
        ...
        (b"(data\n (flags raw)\n (value #11223344556677889900AA#))\n",
         None, 0),
        (b"(data\n (flags pkcs1)\n (value #11223344556677889900AA#))\n",
         Some(KeyAlgorithm::Rsa), error::GPG_ERR_CONFLICT),
        (b"(data\n (flags raw foo)\n (value #11223344556677889900AA#))\n",
...
fn test_pkey() {
  ...
  let keys: &[(pkey::Algorithm, usize, (&[u8], &[u8], &[u8]))] = &[
      (KeyAlgorithm::Rsa, FLAG_CRYPT | FLAG_SIGN,
       (b"(private-key\n\
           (rsa\n\
      ...
      (KeyAlgorithm::Elg, FLAG_SIGN | FLAG_CRYPT,
       (b"(private-key\n\
           (ELG\n\
